...
import SpotifyToken, { getSpotifyToken } from "@/core/services/SpotifyToken";
...
class ApiService {
  ...
  public static setSpotifyHeader(): void {
    ApiService.vueInstance.axios.defaults.headers.common[
      "Authorization"
    ] = `Bearer ${SpotifyToken.getSpotifyToken()}`;
  }

  public static setHeaderBearer(): void {
    ApiService.vueInstance.axios.defaults.headers.common[
      "Authorization"
    ] = `Bearer ${JwtService.getToken()}`;
  }
